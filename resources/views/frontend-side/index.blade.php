...
@section('title', 'HighTech')

@section('content')
    @include('frontend-side.banner')
    <!-- we_do -->
    <div class="we_do">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row d_flex">
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="chose_box">
                        <i><img src="{{asset('assets')}}/images/chose1.png" alt="#"/></i>
                        <h3>Project Done </h3>
                        <strong>1000+</strong>
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="chose_box">
                        <i><img src="{{asset('assets')}}/images/chose2.png" alt="#"/></i>
                        <h3>Happy Clients </h3>
                        <strong>900+</strong>
                        <a class="read_more" href="Javascript:void(0)">Read More</a>
                    </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="chose_box">
                        <i><img src="{{asset('assets')}}/images/chose3.png" alt="#"/></i>
                        <h3>Awards</h3>
                        <strong>100+</strong>
                        <a class="read_more" href="Javascript:void(0)">Read More</a>
                    </div>
                                ...
                                <div class="container">
                                    <div class="carousel-caption posi_in">
                                        <div class="clientsl_text">
                                            <i><img src="{{asset('assets')}}/images/clint.jpg" alt="#"/></i>
                                            <h3>Deno <img src="{{asset('assets')}}/images/icon.png" alt="#"/></h3>
